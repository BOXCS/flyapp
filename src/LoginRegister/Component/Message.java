...
public class Message extends javax.swing.JPanel {
    ...
    public void showMessage(MessageType messageType, String message) {
        ...
        if (messageType == MessageType.SUCCESS) {
            lbMessage.setIcon(new ImageIcon(getClass().getResource("/LoginRegister/icon/success.png")));
        } else {
            lbMessage.setIcon(new ImageIcon(getClass().getResource("/LoginRegister/icon/error.png")));
        }
    }

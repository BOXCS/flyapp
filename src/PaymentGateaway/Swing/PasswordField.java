...
public class PasswordField extends JPasswordField {
    ...
    public PasswordField() {
        ...
        eye = new ImageIcon(getClass().getResource("/paymentGateaway/icon/eye.png")).getImage();
        eye_hide = new ImageIcon(getClass().getResource("/paymentGateaway/icon/eye_hide.png")).getImage();

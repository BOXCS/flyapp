...
public class PlayPortfolio extends javax.swing.JPanel {

    private String portfolioId;

    public PlayPortfolio(String portfolioId) {
        this.portfolioId = portfolioId;
        initComponents();
    }

    private void openVideoPlayer() {
        // Create VideoPortfolio instance and pass portfolioId
        VideoPortfolio videoPortfolio = new VideoPortfolio(portfolioId);

        // Set video portfolio visible
        videoPortfolio.setVisible(true);
    }

package Dashboard.Swing.chart;

import Dashboard.Swing.chart.blankchart.BlankPlotChart;
import Dashboard.Swing.chart.blankchart.BlankPlotChatRender;
import Dashboard.Swing.chart.blankchart.SeriesSize;
...
public class CurveChart extends javax.swing.JPanel {
    ...
    public CurveChart() {
        ...
        blankPlotChart.setBlankPlotChatRender(new BlankPlotChatRender() {
            ...
            public void renderSeries(BlankPlotChart chart, Graphics2D g2, SeriesSize size, int index, List<Path2D.Double> gra) {
                int legendCount = Math.min(legends.size(), 6);
    ...
    private void initComponents() {
        ...
        blankPlotChart = new Dashboard.Swing.chart.blankchart.BlankPlotChart();
    ...
    private Dashboard.Swing.chart.blankchart.BlankPlotChart blankPlotChart;
